...
public enum Category {
    ...
    ALL("총금액", Collections.emptyList(), Collections.emptyList());
    ...
    public static int menuPrice(String menuName) {
        int idx = findByMenu(menuName).getMenu().indexOf(menuName);
        return Category.findByMenu(menuName).getPrice().get(idx);
    }
}
